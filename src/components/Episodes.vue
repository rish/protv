  ...
  <div id="show">
    <div class="container">
      ...
      <div class="container" v-if="home.length">
        <ProCarousel title="Sezonal 1" :items="home[3].items" id="exclusive-online" :grid="home[3].grid" meta="true" synopsis="true"/>
      </div>

      <div class="container" v-if="home.length">
        <ProCarousel title="Sezonal 2" :items="home[3].items" id="newest-uploads" :grid="home[3].grid" meta="true" synopsis="true"/>
      </div>
    ...
    <div class="container">
      ...
      <div class="container" v-if="home.length">
        <ProCarousel title="Sezonal 3" :items="home[3].items" id="exclusive-online" :grid="home[3].grid" meta="true" synopsis="true"/>
      </div>

      <div class="container" v-if="home.length">
        <ProCarousel title="Sezonal 4" :items="home[3].items" id="newest-uploads" :grid="home[3].grid" meta="true" synopsis="true"/>
      </div>
